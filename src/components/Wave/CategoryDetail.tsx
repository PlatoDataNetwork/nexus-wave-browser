...
const CategoryDetail: React.FC = () => {
  ...
  // Get default prompt based on category
  const categoryPrompt = useMemo(() => {
    if (categoryId === 'ar-vr') {
      return 'What are the most innovative AR/VR applications in industries?';
    }
    return `Tell me about recent developments in ${category.name}`;
  ...
  return (
    <div className="flex flex-col h-screen bg-background dark:bg-nexus-space-black">
      ...
      <div className="flex flex-col flex-1 h-0">
        ...
        {/* Chat area with the WaveChat component */}
        <div className="flex-1 h-0">
          <WaveChat 
            initialPrompt={categoryPrompt} 
