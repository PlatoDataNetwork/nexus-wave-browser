...
export const topProtocols: Protocol[] = [
  ...
  { id: "19", name: "Lumia", url: "https://lumia.org", color: "#6B46C1" },
  { id: "20", name: "Magic Eden", url: "https://magiceden.io", color: "#E42575" },
  { id: "21", name: "MakerDAO", url: "https://makerdao.com", color: "#1AAB9B" },
  { id: "22", name: "MarginFI", url: "https://marginfi.com", color: "#3182CE" },
  { id: "23", name: "Near", url: "https://near.org", color: "#000000" },
  { id: "24", name: "Optimism", url: "https://optimism.io", color: "#FF0420" },
  { id: "25", name: "Polkadot", url: "https://polkadot.network", color: "#E6007A" },
  { id: "26", name: "Polygon", url: "https://polygon.technology", color: "#8247E5" },
  { id: "27", name: "Solana", url: "https://solana.com", color: "#00FFA3" },
  { id: "28", name: "Stellar", url: "https://stellar.org", color: "#000000" },
  { id: "29", name: "SushiSwap", url: "https://sushi.com", color: "#F25A91" },
  { id: "30", name: "Synthetix", url: "https://synthetix.io", color: "#00D1FF" },
  { id: "31", name: "Tezos", url: "https://tezos.com", color: "#2C7DF7" },
  { id: "32", name: "The Graph", url: "https://thegraph.com", color: "#6747ED" },
  { id: "33", name: "Uniswap", url: "https://uniswap.org", color: "#FF007A" },
  { id: "34", name: "Yearn", url: "https://yearn.finance", color: "#0657F9" }
];
