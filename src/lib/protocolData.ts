...
export const topProtocols: Protocol[] = [
  ...
  { id: "4", name: "Arweave", url: "https://arweave.org", color: "#4169E1" },  // Changed to royal blue
  { id: "5", name: "Atlas DEX", url: "https://atlasdex.finance", color: "#FF7A00" },
  { id: "6", name: "Avalanche", url: "https://avax.network", color: "#E84142" },
  { id: "7", name: "Balancer", url: "https://balancer.fi", color: "#483D8B" },  // Changed to dark purple
