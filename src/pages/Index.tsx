...
const Index: React.FC<IndexProps> = ({ defaultUrl = "https://Platodata.io" }) => {
  ...
  return (
    <div className="flex flex-col h-screen bg-background dark:bg-nexus-space-black">
      {/* Main browser header with title and time - Using header-bar class for consistent styling */}
      <div className="flex items-center justify-between px-4 py-2 header-bar">
